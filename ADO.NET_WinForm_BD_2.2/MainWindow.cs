...
namespace ADO.NET_WinForm_BD_2._2
{
    ...
    public partial class MainWindow : Form
    {
        ...
        private void cbGroups_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            /*Эта часть кода берет название направления, выбранное пользователем, 
             * "экранирует" в нем одинарные кавычки (заменяя ' на '' для совместимости с SQL)
             * и затем формирует готовую строку условия для SQL-запроса (WHERE D.direction_name = 'выбранное_значение'),
             * которую можно использовать для фильтрации данных в базе.*/
